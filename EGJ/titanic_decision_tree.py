...
# 학습용 데이터 읽어오기
train = pd.read_csv(root_path + "/data/titanic/train.csv", index_col="PassengerId")

# 예측할 데이터 읽어오기
test = pd.read_csv(root_path + "/data/titanic/test.csv", index_col="PassengerId")
...
kaggle_submission = pd.read_csv(root_path + "/data/titanic/gender_submission.csv", index_col="PassengerId")
...
# 제출 파일 생성/저장
kaggle_submission.to_csv(root_path + "/EGJ/kaggle_titanic_submission_eugene.csv")
